...
import com.marketplace.session.ArchivosadjuntosFacade;
...
public class adjuntosArchivosServlet extends HttpServlet {
  @EJB
  private ArchivosadjuntosFacade archivosadjuntosFacade;
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (idadjuntos.equals("")) {
      ...
      archivosadjuntosFacade.guardarAdjuntosArchivos(idadjuntos, idarchivos);
    }
    processRequest(request, response);
  }
