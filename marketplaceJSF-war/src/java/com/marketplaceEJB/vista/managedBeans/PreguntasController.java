...
import com.marketplaceJSF.negocio.session.PreguntasFacade;
...
@ManagedBean(name = "preguntasController")
@SessionScoped
public class PreguntasController implements Serializable {
  @EJB
  private PreguntasFacade ejbFacade;
  ...
  public static class PreguntasControllerConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
      ...
      if (object instanceof Preguntas) {
        ...
        throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Preguntas.class.getName());
      }
    }
